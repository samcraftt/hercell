...
MODEL_PATH = PHASE2_DIR / "saved_models" / "dab_regularized_heatmap_convnext_best.pt"
...
OUTPUT_PATH = PROJECT_ROOT / "dab_regularized_learned_heatmap_example.png"
...
def main():
    ...
    # Resize learned heatmap to 224x224
    ...
    plt.title("DAB-guided learned heatmap")
    plt.axis("off")
